...
<html lang="en">
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
			      	...
			      	<div class="d-flex">
			      		<div class="w-100">
							...
							<form method="POST" action="{{ route('register') }}">
			      			...
			      			<input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" autocomplete="name" autofocusrequired>
			      		</div>
			      		<div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
		            	<label class="label"for="password-confirm">ConfirmPassword</label>
		          ...
		          <p class="text-center">Not a member? <a class="nav-link" href="{{route('login') }}">{{ __('Login') }}</a></p>
				  @endif
		        </div>
		      </div>
				</div>
  ...
  <script src="{{asset('js1/main.j')}}s"></script>
